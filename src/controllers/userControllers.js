...
export const finishGithubLogin = async (req, res) => {
    ...
    if("access_token" in tokenRequrest){
        const {access_token} =tokenRequrest;
...
export const postChangePassword = async (req, res) => {
    ...
    if(newPassword !== newPasswordConfirmaion){
        return res.statue(400).render("users/change-password", {pageTitle:"Change Password", errorMessage:"The password does not match the confirmation."});
    }
